...
- 2026-06-25 — Windows/Claude: añadida **figura de visión general del experimento** (`sistema-experimento.png`, del diagrama de bloques de Sem3, reducida a 1600 px) al reporte (inicio de Arquitectura) y a la presentación (lámina overview → **25 lám**). Caption la enmarca como conceptual y aclara los números actuales; ⚠️ los números embebidos en la imagen son de Sem3 (27 MSPS/~1024). Reporte sigue en 15 pág. PDFs semifinales refrescados. Opcional: regenerar el diagrama como TikZ con cifras actuales.
- 2026-06-26 — Windows/Claude: **presentación** — lámina *Continuidad del proyecto*: añadidas **referencias temporales** a las viñetas (Sem 2/3 = 2025, Sem 4 = ene–jun 2026) + **diagrama TikZ de bloques** (señal → ADC AD9226 físico → FPGA Tang Nano 9K → PC/UART) con nota "sin preamplificador". Reemplazada la lámina *Conclusiones* por un **Mapa cronológico** (timeline TikZ hecho·aquí·falta: nodos verdes Sem2/3 ✓, naranja Sem4 "AQUÍ", huecos Sem5/6; pie con hecho/aquí/falta y el hito). Presentación sigue en **25 lám**, compila limpio. PDF de entregables refrescado.
- 2026-06-26 — Windows/Claude: **presentación** (2ª pasada). *Cronograma del siguiente periodo*: encabezado **Sem 5 = ago–dic 2026 (≈18 semanas)** + columna **≈Sem.** por bloque (3/2/3/2/3/2/3) y fila **Total = 18**. *Mapa cronológico*: ampliado a **Sem 1 → Sem 8 (4 años)** con fechas (Sem1 2024, Sem2/3 2025, Sem4 ene–jun 26 = AQUÍ, Sem5 ago–dic 26, Sem6 2027, Sem7 2027, Sem8 2028); cierre del doctorado en **DL/CNN + transfer learning** (detección / segmentación semántica) en Sem 7–8; pie "Falta" actualizado. Compila limpio, **25 lám**; PDF de entregables refrescado.
